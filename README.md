...
## 安装&更新 ##
    wget -q -N --no-check-certificate https://raw.githubusercontent.com/boluosaidong/SSR-Bash-Python/master/install1.sh && bash install1.sh
...
## 卸载 ##
    wget -q -N --no-check-certificate https://raw.githubusercontent.com/boluosaidong/SSR-Bash-Python/master/install1.sh && bash install1.sh uninstall

## 离线安装 ##
    #此方法可用于网络情况不好，导致缺少文件的情况.亦可下载该脚本，用于备份
    wget -q -N --no-check-certificate https://down.fdos.me/install1.sh && bash install.sh
